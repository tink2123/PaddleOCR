...
class SRNLoss(nn.Layer):
    def __init__(self, **kwargs):
        ...
        self.ctc_loss_func = nn.CTCLoss(blank=6624, reduction='none')
    ...
    def forward(self, predicts, batch):
        ...
        ctc_labels = batch[1].astype("int32")
        ...
        #     "ctc_predict:",
        #     paddle.argmax(
        #         paddle.nn.functional.softmax(ctc_predict), axis=2).numpy().reshape(1,-1))
        ...
        sum_cost = cost_word + cost_vsfd + cost_gsrm * 0.15 + ctc_loss * 2.5
        #sum_cost = cost_word + ctc_loss
        #return {'loss': sum_cost, 'word_loss': cost_word, 'ctc_loss': ctc_loss}
