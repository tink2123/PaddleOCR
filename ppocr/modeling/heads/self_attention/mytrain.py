...
train_dg = dg.datagen(filelist, batchsize, vocab_fpath, train_imgshape,args.imgs_dir)
...
# for pass_id in range(1,TrainTaskConfig.pass_num):
    #train a epoch
train_exe = train_loop(exe, train_prog, startup_prog, dev_count, sum_cost, avg_cost,
       token_num, predict, None,args=args,train_dg=train_dg,pass_id=0,vali_dg=vali_dg)
    #
