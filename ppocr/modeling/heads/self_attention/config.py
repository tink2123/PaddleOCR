class TrainTaskConfig(object):
    #filelist
    filelist=[('tensorflow.JPG','tensorflow')]#such as [('tensorflow.png','tensorflow')]
    ...
    ckpt_path = None#'trained_ckpts/pass_90.ckpt.model'
...
class InferTaskConfig(object):
    ...
    model_path = "trained_models/latest.infer.model"
