...
class MobileViT(nn.Layer):
    def __init__(self,
        ...
        # [B, 32, 128, 128]
        self.mv2_block_2 = MobileV2Block(dims[1], dims[2], stride=(2,1))
        # [B, 48, 64, 64]
        # [B, 48, 16, 128]
        ...
        # [B, 64, 32, 32]
        self.mv2_block_6 = MobileV2Block(dims[5], dims[6], stride=(2,1))
        # [B, 80, 16, 16]
        self.mvit_block_2 = MobileViTBlock(dims[6], hidden_dims[1], depth=4)

        # [B, 80, 16, 16]
        self.mv2_block_7 = MobileV2Block(dims[6], dims[7], stride=(2,1))
        # [B, 96, 8, 8]
