...
class CPULiteNet(nn.Layer):
    def __init__(self, scale=1.0, class_dim=1000):
        ...
        self.last_conv = Conv2D(
            in_channels=make_divisible(int(1024 * scale)),
            out_channels=1280,
            kernel_size=1,
            stride=1,
            padding=0,
...
def CPULiteNet_x0_25(**args):
    model = CPULiteNet(scale=0.25, **args)
    return model


def CPULiteNet_x0_35(**args):
    model = CPULiteNet(scale=0.35, **args)
    return model


def CPULiteNet_x0_5(**args):
    model = CPULiteNet(scale=0.5, **args)
    return model
